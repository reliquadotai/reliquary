...
wallet-free validator deployment remain to be implemented and qualified.
Executor and signer URLs stay opt-in. A code merge does not change any host's
role, keys, active profile, network exposure or chain authority.

## Historical deployment and research baseline — August 2026

The observations below and reports 01–09 describe the inspected August
revisions. They are retained as historical evidence, not a current production
inventory or qualification of the reconciled source. In particular, V1 already
includes immutable checkpoint and resume protections that the old review
